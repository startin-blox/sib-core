describe('solid-map', function() {
  ...
  it('display content in popup markers', () => {
    ...
    cy.get('#map-2 .leaflet-popup-content solid-display > solid-set-default')
      .should('have.length', 1)
      .and('have.attr', 'name', 'infos')
    cy.get('#map-2 .leaflet-popup-content solid-display > solid-set-default[name=infos] > solid-display-value').should('have.length', 2)
    cy.get('#map-2 .leaflet-popup-content solid-display > solid-set-default[name=infos] > solid-display-value[name=name]').contains('Test 1')
    cy.get('#map-2 .leaflet-popup-content solid-display > solid-set-default[name=infos] > solid-display-value[name=category]').contains('showcase event')
  })
  it('groups markers', () => {
