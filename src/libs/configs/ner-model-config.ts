...
export const NER_MODEL_CONFIG = {
  ...
  modelPath: "https://cdn.startinblox.com/models/3dobjects/search/models/ner_model_quantized.onnx",
  
  // Alternative model paths (for different domains or models)
  alternatives: {
    documents: {
      tokenizerPath: "https://cdn.startinblox.com/models/documents/search/models/ner_tokenizer/",
      modelPath: "https://cdn.startinblox.com/models/documents/search/models/ner_model_quantized.onnx"
    },
    products: {
      tokenizerPath: "https://cdn.startinblox.com/models/products/search/models/ner_tokenizer/",
      modelPath: "https://cdn.startinblox.com/models/products/search/models/ner_model_quantized.onnx"
    }
  }
};
 ...
 */
export function getModelConfig(domain: string = '3dobjects') {
  if (domain === '3dobjects') {
    return {
  ...
  console.warn(`No model configuration found for domain '${domain}', using default 3D objects model`);
  return {
    tokenizerPath: NER_MODEL_CONFIG.tokenizerPath,
    modelPath: NER_MODEL_CONFIG.modelPath
  };
